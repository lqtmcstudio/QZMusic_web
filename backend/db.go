...
func (s *Store) migrate(ctx context.Context) error {
        ...
        // Add body column to github_commits if missing (for existing databases).
        s.db.ExecContext(ctx, `ALTER TABLE github_commits ADD COLUMN body TEXT NOT NULL DEFAULT ''`)
